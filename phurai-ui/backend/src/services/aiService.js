...
3. Return JSON with:
   ...
   - "isFood": true,
   - "detectedFoodName": "AI Recommendation"
...
CRITICAL: Return ONLY raw, valid JSON. Do not include markdown code block backticks (\`\`\`json).`;
    ...
    throw new Error("Failed to process text search.");
};