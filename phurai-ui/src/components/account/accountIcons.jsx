...
export function StatusIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      ...
      <path d="M7 8.5h.01M13 8.5h.01M7.5 13c1 1 4 1 5 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function SignOutIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M8 4H4v12h4M12 10H8M12 10l2-2M12 10l2 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function AddAccountIcon() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <circle cx="10" cy="7" r="3" stroke="currentColor" strokeWidth="1.5" />
      <path d="M4 17c0-2.5 2-4.5 6-4.5M14 14v4M12 16h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
