...
dotenv.config({ path: path.resolve('/Users/phu/Documents/GitHub/SWP391-GROUP-3-RESTAURANT-MANAGEMENT-SYSTEM/phurai-ui/server/.env') });

const API_BASE = 'http://localhost:8080/api';
const SEPAY_WEBHOOK = 'http://localhost:8080/sepay-webhook';
...
async function runTests() {
  ...
  try {
    ...
    try {
        ...
        // May fail if already null or syntax issue, ignore for now
