...
import '@/features/home/styles/unique-experience.css';
...
function AccordionPanel({ item }) {
  ...
  return (
    ...
    >
      ...
      <span className="uxp-panel__caption-vertical">{item.title}</span>
    </button>
  );
}
...
export function UniqueExperienceAccordion() {
  ...
  return (
    ...
    >
      <h2 id="uxp-heading" className="uxp-title" style={{ textAlign: 'center', marginBottom: '3rem', width: '100%' }}>
        A UNIQUE EXPERIENCE
      </h2>
