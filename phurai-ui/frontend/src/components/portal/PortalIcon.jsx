...
const PATHS = {
  ...
  orders:      "M6 2h12v20l-2-1.5L14 22l-2-1.5L10 22l-2-1.5L6 22zM9 7h6M9 11h6M9 15h4",
  wallet:      "M3 7h15a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm0 0V6a2 2 0 012-2h11M17 13h.01",
  revenue:     "M3 7h15a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm0 0V6a2 2 0 012-2h11M17 13h.01",
  ...
  "floor-plan":"M4 7h16M4 7v10M20 7v10M4 17h16M9 7v10M15 7v10",
  floorplan:   "M4 7h16M4 7v10M20 7v10M4 17h16M9 7v10M15 7v10",
  layout:      "M4 7h16M4 7v10M20 7v10M4 17h16M9 7v10M15 7v10",
  ...
  staff:       "M16 19v-2a3 3 0 00-3-3H6a3 3 0 00-3 3v2M9.5 11a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM21 19v-2a3 3 0 00-2.2-2.9M16 4.1A3.5 3.5 0 0116 11",
...
function PortalIcon({ name, size = 18, strokeWidth = 1.7, className = "", style }) {
  const d = PATHS[name] || PATHS.receipt || PATHS.grid;
  if (!d) return null;
  return (
    <svg
      className={className}
