...
function AboutUsSection() {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', marginBottom: '3rem', width: '100%', margin: '0 auto 3rem auto', display: 'block' }} className="phurai-about__kicker">ABOUT PHŪRAI</h2>
      ...
      <div className="phurai-about__inner">
        ...
        <div className="phurai-about__content">
          ...
          <h2 id="about-heading" className="phurai-about__headline">
            Where Vietnamese Tradition Meets Modern Culinary Art
          </h2>

          <p className="phurai-about__lead">
            Phūrai is crafted for guests who seek more than a meal. Inspired by the quiet precision
            of Vietnamese dining and the warmth of modern hospitality, every detail is designed to feel
