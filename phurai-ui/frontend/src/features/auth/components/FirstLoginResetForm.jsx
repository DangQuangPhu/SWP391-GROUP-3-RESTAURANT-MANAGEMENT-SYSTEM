...
import { firstLoginReset } from "../services/authApi.js";
...
function FirstLoginResetForm({ email, token, onSuccess, onBack }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      setLoading(true);
      setAlert("");
      const data = await firstLoginReset({
        token,
  ...
  return (
    <div className="auth-card">
      ...
      <h2 className="auth-card__title">Security Required</h2>
      <p className="auth-card__subtitle">
        For your security, please change your default password to continue accessing your account.
      </p>
...
export default FirstLoginResetForm;
